...
Telnyx STT fronts a dozen engines behind one key (`telnyx.stt_engine`); the in-house `Telnyx` engine is finals-only, so barge-in and live captions need a hosted engine such as `Deepgram`.
